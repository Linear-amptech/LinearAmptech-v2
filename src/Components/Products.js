      ...
      >
        ...
        <CardFooter className="pt-0">
          <NavLink
            ...
            className="align-middle select-none  font-semibold text-center transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 px-6 bg-gradient-to-tr from-gray-900 to-gray-700 text-white shadow-md shadow-gray-900/10  hover:shadow-gray-900/20 active:opacity-[0.85] rounded-sm capitalize"
          >
            Read More
          </NavLink>
        </CardFooter>
