...
export const products: Product[] = [
  ...
  },
  {
    ...
    features: ["Active antenna", "Prototype", "Validation"],
    specs: [
      { label: "Product family", value: "Active antenna prototype" },
      { label: "Scope", value: "RF front-end and antenna integration" },
      { label: "Validation", value: "Measurement and chamber workflows" },
      { label: "Use cases", value: "Phased arrays, RIS, and RF systems" },
    ],
    detailSections: [
      {
        title: "Product brief",
        body: "Active antenna work connects RF front-end electronics, matching networks, antenna hardware, and validation into a prototype-ready system path.",
      },
      {
        title: "Integration workflow",
        body: "The workflow supports prototype hardware, LNA sections, matching networks, return-loss checks, gain measurements, and radiation-pattern validation.",
      },
      {
        title: "Deployment fit",
        body: "The product path is suited for customer programs that need active antenna proof-of-concepts, measured RF behavior, and system-level iteration.",
      },
    ],
    gallery: [
      {
      ...
      },
      {
        ...
        alt: "Active antenna return loss measurement",
        caption: "Return loss validation",
      },
      {
        src: assets.sourceActiveAntennaGain,
        alt: "Active antenna gain measurement",
        caption: "Gain validation",
      },
      {
        src: assets.sourceActiveAntennaPattern,
        alt: "Active antenna radiation pattern",
        caption: "Radiation pattern validation",
      },
    ],
  },
  {
    ...
    features: ["RIS", "6G", "Prototype"],
    specs: [
      { label: "Product family", value: "RIS prototype" },
      { label: "Scope", value: "Front-side and back-side array hardware" },
      { label: "Validation", value: "Lab and RF measurement workflows" },
      {
        label: "Use cases",
        value: "6G, propagation control, and RIS research",
      },
    ],
    detailSections: [
      {
        title: "Product brief",
        body: "RIS prototype work supports reconfigurable intelligent surface research with physical array hardware, RF validation, and iteration paths for advanced wireless programs.",
      },
      {
        title: "Prototype scope",
        body: "The available visuals and workflow cover front-side arrays, back-side array structures, close-up hardware details, and lab validation.",
      },
      {
        title: "Application fit",
        body: "This product path is intended for 6G, reconfigurable propagation, active antenna adjacency, and customer-specific RIS prototype programs.",
      },
    ],
    gallery: [
      {
        src: assets.sourceRisFrontSideArray,
        alt: "RIS front-side array",
        caption: "RIS front-side array",
      },
      {
        src: assets.sourceRisBackSideArray,
        alt: "RIS back-side array",
        caption: "RIS back-side array",
      },
      {
  ...
  },
  {
    ...
    features: ["Packaging", "Integration", "mm-wave"],
    specs: [
      { label: "Product family", value: "mm-wave packaging and integration" },
      { label: "Scope", value: "Chip-to-PCB-to-waveguide transitions" },
      { label: "Hardware", value: "Prototype packages and RF assemblies" },
      { label: "Use cases", value: "High-frequency IC and module deployment" },
    ],
    detailSections: [
      {
        title: "Product brief",
        body: "Packaging and integration work bridges IC, PCB, waveguide, module, and measurement constraints for high-frequency RF deployment.",
      },
      {
        title: "Integration scope",
        body: "The workflow includes package transition design, chip-to-PCB-to-waveguide assemblies, prototype hardware, and radial combiner concepts.",
      },
      {
        title: "Program fit",
        body: "This product path is designed for customers moving from measured chips toward deployable RF assemblies and integration-ready prototypes.",
      },
    ],
    gallery: [
      {
        src: assets.sourcePackagingChipPcbWaveguide,
        alt: "Chip PCB waveguide packaging transition",
        caption: "Chip-to-PCB-to-waveguide transition",
      },
      {
        src: assets.sourcePackagingTransitionDiagram,
        alt: "Packaging transition diagram",
        caption: "Packaging transition concept",
      },
      {
        src: assets.sourcePackagingPrototypePhoto,
        alt: "Packaging prototype hardware",
        caption: "Prototype packaging hardware",
      },
      {
        src: assets.sourcePackagingRadialCombiner,
        alt: "Packaging radial combiner",
        caption: "Radial combiner concept",
      },
    ],
  },
];
