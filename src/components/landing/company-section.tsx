  ...
  return (
    <section id="company" ref={sectionRef} className="relative h-[300vh]">
      <div className="sticky top-0 flex min-h-screen items-center pt-20 pb-8 lg:pt-24 lg:pb-12 bg-[#f1f2f5]">
        <div className="container mx-auto flex w-full flex-col items-center gap-8 px-5 lg:grid lg:grid-cols-[0.95fr_1.05fr] lg:items-center lg:gap-12 lg:px-8 bg-[#f1f2f5]">
          ...
          <div className="relative order-1 w-full   h-[46vh] sm:h-[52vh] lg:order-2 lg:h-auto lg:aspect-[9/16] lg:max-h-[88vh]">
