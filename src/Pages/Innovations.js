...
const Innovations = () => {
  ...
  return (
    <div className="bg-[#f5f8fa]">
      ...
      <div className="lg:pr-40 lg:pl-40 mx-auto ">
        <div className=" bg-white container px-4 py-12 rounded-sm">
          <div></div>
          ...
          <div className="flex flex-col lg:flex-row justify-between">
            <div className="w-[100%] lg:w-[50%]">
              ...
              <ul className="list-disc my-3 ml-8 flex flex-col gap-1 text-gray-800">
                <li>
                  Linear Amptech's Cloud Analytics solution is designed to
                  monitor sensors and generate valuable insights from them.
                </li>
                <li>
                  The process begins with data ingestion, where data from
                  various sensors is collected in real-time and transmitted to
                  our cloud-based platform for analysis.
                </li>
                <li>
                ...
                <li>
                  A comprehensive analysis report is generated and shown in a
              ...
              <ul className="list-disc my-3 ml-8 flex flex-col gap-1 text-gray-800">
                ...
                <li>
                  Access to advanced techniques to detect issues before the
                  actual building
                </li>
              </ul>
            </div>
      ...
      {/* new two big images */}
      <div className="lg:pr-40 lg:pl-40 mx-auto ">
        <div className="container px-4 py-12 bg-white my-12">
          ...
          <p className=" leading-relaxed max-w-[1085px] m-auto mt-6 text-[1.1rem] text-justify text-gray-800">
            ...
            winters when fog reduces visibility. Blind intersections and turns
            in hilly terrain pose a significant danger to drivers who may be
            slow to respond to honking or ignore their lanes. This can result in
            ...
            radar technology to detect approaching vehicles and alert drivers
            with dynamic warning signs. The system can be deployed with road
          ...
          <div className="lg:flex justify-between">
            <div className="lg:w-[50%]">
              ...
              <ul className=" my-3 ml-8 flex flex-col gap-1 list-square text-gray-800">
                ...
                <li>
                  Still LoRaWAN: end-to-end encryption, spreading factors,
                  channel hopping
                </li>
