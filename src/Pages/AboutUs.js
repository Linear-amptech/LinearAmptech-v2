  ...
  return (
    <div className="bg-[#f5f8fa]">
      ...
      <div className="heroSection   ">
        ...
        >
          <h2
            className="lg:text-[4rem] md:text-5xl text-4xl font-bold  drop-shadow-2xl text-center"
            data-aos="fade-up"
          >
            Get to Know Us
          </h2>
          <h2
            className="lg:text-[4rem] md:text-5xl text-4xl font-bold  drop-shadow-2xl text-center lg:mt-8 p-1"
            data-aos="fade-up"
          >
