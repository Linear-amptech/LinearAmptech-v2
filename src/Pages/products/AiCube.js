        ...
        <section className="  lg:pt-8 pt-4 xl:pt-12 ">
          ...
          <div className="container lg:flex lg:px-[12%] pt-12 mx-auto text-left px-4">
            <div className="lg:w-[50%]">
              <h2 className="font-bold lg:text-[40px] leading-relaxed text-3xl text-gray-900 mb-2 ">
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
              <div className="text-left bg-white rounded-sm shadow-sm   ">
                ...
                <div className="px-4 py-4">
                  ...
                  <p className="mt-2 text-gray-700 ">
                    ...
                    easier for companies of all scales to develop machine
                    learning models, manage them, and integrate hardware
                    sensors.
                  </p>
                </div>
              </div>
              ...
              <div className="text-left  bg-white rounded-sm shadow-sm  ">
                ...
                <div className="p-4">
                  ...
                  <p className="mt-2 text-gray-700 ">
                    ...
                    supercomputers, enabling companies to meet their specific
                    data security and cost-efficiency requirement.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-sm shadow-sm   ">
                ...
                <div className="p-4">
                  ...
                  <p className="mt-2 text-gray-700 ">
                    Our platform's intuitive interface and robust feature set
                    make it accessible to both technical and non-technical
                    users, enabling cross-functional collaboration and faster
                    innovation.
                  </p>
                </div>
              </div>
